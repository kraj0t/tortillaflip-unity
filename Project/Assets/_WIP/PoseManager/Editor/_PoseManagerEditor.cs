...
public class PoseManagerEditor : Editor 
{
	...
	public override void OnInspectorGUI () 
	{
        ...
        var skin = poseManager.skinnedRenderer;
        var skinSO = new SerializedObject(skin);
        EditorGUILayout.PropertyField(skinSO.FindProperty("bones"));
        skinSO.ApplyModifiedProperties();
        /*
        this.serializedObject.FindProperty()
        foreach (var b in poseManager.skinnedRenderer.bones)
        {
            
            EditorGUILayout.ObjectField(b, b.GetType(), true);
        }
        */
	}
